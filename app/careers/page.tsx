...
export default function CareersPage() {
  return (
    <div className="container py-12">
      <h1 className="text-3xl font-bold mb-8 text-dark-blue">Join Our Team</h1>

      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-dark-blue">Open Positions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Marketing Position */}
          <div className="bg-gray-100 p-6 rounded-lg">
            <h3 className="text-xl font-bold mb-2 text-dark-blue">Digital Marketing Specialist</h3>
            ...
            <p className="text-sm text-gray-600">Location: Remote | Department: Marketing | Focus: SEO, SEM, Social Media</p>
          </div>

          {/* Development Position - Level 1 */}
          <div className="bg-gray-100 p-6 rounded-lg">
            <h3 className="text-xl font-bold mb-2 text-dark-blue">Frontend Developer (Mid-Level)</h3>
            ...
            <p className="text-sm text-gray-600">Location: Remote | Department: Development | Technologies: React, Next.js, TypeScript, Tailwind CSS</p>
          </div>

          {/* Development Position - Level 2 */}
          <div className="bg-gray-100 p-6 rounded-lg">
            <h3 className="text-xl font-bold mb-2 text-dark-blue">Backend Developer (Senior)</h3>
            ...
            <p className="text-sm text-gray-600">Location: Remote | Department: Development | Technologies: Node.js, Express, Databases (e.g., PostgreSQL, MongoDB)</p>
          </div>
        </div>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4 text-dark-blue">Application Form</h2>
        <form className="bg-gray-100 p-6 rounded-lg">
          ...
          <div className="mb-4">
            <label htmlFor="position" className="block text-sm font-medium text-dark-blue">Applying For Position</label>
          ...
          <div className="mb-4">
            <label htmlFor="cv" className="block text-sm font-medium text-dark-blue">Upload CV</label>
          ...
          <div className="mb-6">
            <label htmlFor="motivationLetter" className="block text-sm font-medium text-dark-blue">Upload Motivation Letter</label>
